 ...
 * @author nworbnhoj (modification)
 */
public class TrieLayout extends AbstractLayout implements Layout {
...
//    private transient int currentSiblings_;
    ...
    public TrieLayout(SparseTree g) {
        super(g);
    ...
    public TrieLayout(SparseTree g, int distx) {
        super(g);
        //logger.info("Constructor for TreeLayout called" + g.getClass());
        //logger.info("Setting root Node" + g.getRoot());
        this.m_rootVertex = g.getRoot();
    ...
    public TrieLayout(SparseTree g, int distx, int disty) {
        super(g);
        //logger.info("Constructor for TreeLayout called" + g.getClass());
        //logger.info("Setting root Node" + g.getRoot());
        this.m_rootVertex = g.getRoot();
    ...
    void buildTree(Vertex v, int x) {
        ...
        if (!allreadyDone.contains(v)) {
            ...
            Collections.sort(successors, new Comparator<Vertex>(){
                public int compare(Vertex o1, Vertex o2){
                    if (o1.containsUserDatumKey("sortby") && o1.containsUserDatumKey("sortby")){
                        String o1id = o1.getUserDatum("sortby").toString();
                        String o2id = o2.getUserDatum("sortby").toString();
